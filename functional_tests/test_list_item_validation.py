...
class ItemValidationTest(FunctionalTest):
    """Test suite for validating to-do list items."""

    def get_error_element(self) -> WebElement:
        """Return the error web element being displayed."""
        return self.browser.find_element_by_css_selector(".has-error")

    def test_cannot_add_empty_list_items(self) -> None:
        """Test that empty list itmems would be rejected."""
    ...
    def test_cannot_add_duplicate_items(self) -> None:
        """Test for invalidation of duplicate items."""
    ...
    def test_error_messages_are_cleared_on_input(self) -> None:
        """Test error message disappears as user types."""
